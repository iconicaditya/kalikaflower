  ...
  try {
    ...
    await sql`
      insert into plants (
        ...
        ${slug}, ${name}, ${botanicalName}, ${category}, ${price}, ${compareAtPrice}, ${currency},
        ${shortDescription}, ${description}, ${careLevel}, ${light}, ${water}, ${height},
        ${potIncluded}, ${images}, ${tags}, ${inStock}, ${stockCount}, ${featured},
        ${newArrival}, ${bestseller}, 0, 0, now(), now()
      )
    `;
    ...
    return fail((error as Error).message || 'Unable to create plant', 500);
  }
}
